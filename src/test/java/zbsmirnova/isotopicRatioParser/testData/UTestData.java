...
public class UTestData {
    public static final int FIRST_U_ID = 100009;
    public static final int SECOND_U_ID = 100010;
    public static final int THIRD_U_ID = 100011;
    ...
    public static final U THIRD_U = new U(THIRD_U_ID, "thirdU", LocalDate.parse("2015-05-30"), 338.335, 0.335);
